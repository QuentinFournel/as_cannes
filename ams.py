...
def load_all_files_from_drive():
    ...
    for file in files:
        if file['name'].endswith(('.xlsx', '.csv')):
            ...
            st.write(f"Ignoré (non Excel/CSV) : {file['name']}")
...
@st.cache_data
def collect_collective_data():
    # Chargement des données
    df = pd.read_excel('AMS/Données collectives/AS Cannes.xlsx')
...
def collect_individual_data():
    # Ligue 1
    ligue1_ailier = read_with_competition('AMS/Données individuelles/Ligue 1 - Ailier.xlsx')
    ligue1_buteur = read_with_competition('AMS/Données individuelles/Ligue 1 - Buteur.xlsx')
    ligue1_defenseur_central = read_with_competition('AMS/Données individuelles/Ligue 1 - Défenseur central.xlsx')
    ligue1_lateral = read_with_competition('AMS/Données individuelles/Ligue 1 - Latéral.xlsx')
    ligue1_milieu = read_with_competition('AMS/Données individuelles/Ligue 1 - Milieu.xlsx')
    ligue1_milieu_offensif = read_with_competition('AMS/Données individuelles/Ligue 1 - Milieu offensif.xlsx')

    # Ligue 2
    ligue2_ailier = read_with_competition('AMS/Données individuelles/Ligue 2 - Ailier.xlsx')
    ligue2_buteur = read_with_competition('AMS/Données individuelles/Ligue 2 - Buteur.xlsx')
    ligue2_defenseur_central = read_with_competition('AMS/Données individuelles/Ligue 2 - Défenseur central.xlsx')
    ligue2_lateral = read_with_competition('AMS/Données individuelles/Ligue 2 - Latéral.xlsx')
    ligue2_milieu = read_with_competition('AMS/Données individuelles/Ligue 2 - Milieu.xlsx')
    ligue2_milieu_offensif = read_with_competition('AMS/Données individuelles/Ligue 2 - Milieu offensif.xlsx')

    # National 1
    nat1_ailier = read_with_competition('AMS/Données individuelles/National 1 - Ailier.xlsx')
    nat1_buteur = read_with_competition('AMS/Données individuelles/National 1 - Buteur.xlsx')
    nat1_defenseur_central = read_with_competition('AMS/Données individuelles/National 1 - Défenseur central.xlsx')
    nat1_lateral = read_with_competition('AMS/Données individuelles/National 1 - Latéral.xlsx')
    nat1_milieu = read_with_competition('AMS/Données individuelles/National 1 - Milieu.xlsx')
    nat1_milieu_offensif = read_with_competition('AMS/Données individuelles/National 1 - Milieu offensif.xlsx')

    # National 2
    nat2_ailier = read_with_competition('AMS/Données individuelles/National 2 - Ailier.xlsx')
    nat2_buteur = read_with_competition('AMS/Données individuelles/National 2 - Buteur.xlsx')
    nat2_defenseur_central = read_with_competition('AMS/Données individuelles/National 2 - Défenseur central.xlsx')
    nat2_lateral = read_with_competition('AMS/Données individuelles/National 2 - Latéral.xlsx')
    nat2_milieu = read_with_competition('AMS/Données individuelles/National 2 - Milieu.xlsx')
    nat2_milieu_offensif = read_with_competition('AMS/Données individuelles/National 2 - Milieu offensif.xlsx')
...
if __name__ == '__main__':
    ...
    if st.session_state.authenticated:
        ...
        df_collective = collect_collective_data()
